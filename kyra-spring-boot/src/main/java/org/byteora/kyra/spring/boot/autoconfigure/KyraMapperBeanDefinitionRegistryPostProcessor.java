...
public final class KyraMapperBeanDefinitionRegistryPostProcessor implements BeanDefinitionRegistryPostProcessor,
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        ...
        for (String beanDefinitionName : beanDefinitionNames) {
            ...
            KyraScan kyraScan = beanClass.getAnnotation(KyraScan.class);
            if (kyraScan == null) {
                continue;
            }
            for (String mapperPackage : kyraScan.mapper()) {
