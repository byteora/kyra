...
public final class GeneratedRowMapper<T> implements RowMapper<T> {
    ...
    private static FieldBinding[] buildFieldBindings(Reflector<?> reflector,
     ...
     */
    private static Map<String, FieldBinding> buildFieldIndex(FieldBinding[] bindings, Reflector<?> reflector) {
